...
namespace Grupo_negro.Migrations
{
    ...
    [Migration("20251023021129_AgregarUsuariosRealesDePrueba")]
    partial class AgregarUsuariosRealesDePrueba
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Grupo_negro.Models.ApuestaCombinada", b =>
                {
                    ...
                    b.ToTable("ApuestasCombinadas");
                });

            modelBuilder.Entity("Grupo_negro.Models.BonoUsuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("BonosUsuarios");
                });

            modelBuilder.Entity("Grupo_negro.Models.Comentario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Grupo_negro.Models.DetalleApuestaCombinada", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("ApuestaCombinadadId")
                        .HasColumnType("INTEGER");

                    b.Property<decimal>("CuotaSeleccionada")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ApuestaCombinadadId");

                    b.HasIndex("PartidoId");

                    b.ToTable("DetallesApuestasCombinadas");
                });
            ...
            modelBuilder.Entity("Grupo_negro.Models.BonoUsuario", b =>
                {
                    b.HasOne("Grupo_negro.Models.ApplicationUser", "AsignadoPor")
                        .WithMany()
            ...
            modelBuilder.Entity("Grupo_negro.Models.Comentario", b =>
                {
                    b.HasOne("Grupo_negro.Models.Comentario", "ComentarioPadre")
                        .WithMany("Respuestas")
            ...
            modelBuilder.Entity("Grupo_negro.Models.DetalleApuestaCombinada", b =>
                {
                    b.HasOne("Grupo_negro.Models.ApuestaCombinada", "ApuestaCombinada")
                        .WithMany("Detalles")
                        .HasForeignKey("ApuestaCombinadadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
